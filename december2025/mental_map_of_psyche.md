...
graph LR
    ...
    Target(ИСТИННАЯ ЦЕЛЬ:<br/>Индивидуальный Субъект<br/>со сверхспособностями<br/>/ Владелец Джинна):::core
...
### 2. ИСТИННАЯ ЦЕЛЬ: Владелец Джинна (The Sovereign Mage)
...
*   **Свойства:**
    ...
    *   **Универсальность:** Я могу делать всё (наука, бизнес, арт) через Джинна.
